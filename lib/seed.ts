...
export const seoulSeedData: SeedData = {
  ...
  "shopping": {
    "items": [
      {"id":"shop-1","title":"Olive Young 面膜補貨","category":"美妝 / 護膚","area":"Hongdae","note":"可先比較 1+1 優惠","completed":false},
      {"id":"shop-2","title":"零食手信（餅乾 / 海苔）","category":"零食 / 手信","area":"Myeongdong","note":"優先買可常溫保存款","completed":false},
      {"id":"shop-3","title":"襪子與基本內搭","category":"服飾 / 配件","area":"Seongsu","note":"","completed":false},
      {"id":"shop-4","title":"藥妝常備品","category":"藥妝 / 健康","area":"Hongdae","note":"按實際需要補貨","completed":true}
    ]
  }
};
